...
import {buildCavabiensepasserHttpRequest, httpClient, toHttpParams} from "../utils/api.ts";
...
export default function Search(props: Readonly<{ setData: Dispatch<SetStateAction<ChartShallowDataShape[] | undefined>> }>) {
    ...
    const searchQuery = useQuery<ChartShallowDataShape[]>({
        ...
        queryFn: async () => {
            ...
            return await httpClient(buildCavabiensepasserHttpRequest('/dashboard'), options).json();
        },
        enabled: false
    });
